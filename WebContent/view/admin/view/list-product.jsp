				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<a href="<c:url value='/admin/product/add'/>" class="btn" style="color: #fff;background-color: #21c0c0;border-color: #357ebd;margin-left:16px">Thêm sản phẩm mới</a>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<c:forEach items="${proList }" var="pro" >
											<tr class="odd gradeX">
												<td>${pro.id }</td>
													<c:url value="/view/client/static/img/products/${pro.image }" var="imgUrl"></c:url>
