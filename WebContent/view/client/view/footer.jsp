			...
			<div class="row">
				...
				<div class="col-md-4 md-margin-bottom-40">
					...
					<ul class="list-unstyled address-list margin-bottom-20">
						...
						<li><i class="fa fa-angle-right"></i>Phone: 0383.729.419</li>
						<li><i class="fa fa-angle-right"></i>Hotline: 0383.729.419</li>
						<li><i class="fa fa-angle-right"></i>Email:
							nguyendanhthai1605@gmail.com</li>
					</ul>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<p>
						2020 &copy; Phát triển bởi nhóm 8 | <a
